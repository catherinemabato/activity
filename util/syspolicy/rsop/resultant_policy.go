...
// ErrResultantPolicyClosed is returned by [Policy.Reload], [Policy.addSource],
...
// subscribe and receive a callback whenever the resultant [setting.Snapshot] is changed.
//
...
type Policy struct {
	...
	// resultant is the most recent version of the [setting.Snapshot]
